...
interface (SEI) formation in a Li-ion battery (LIB). This model will consider
1D growth of a homogeneous SEI with variable thickness and composition.
"""
...
from sei_1d_functions import residual_homogeneous
...
from sei_1d_init_homogeneous import SV_0, SV_dot_0, SVptr, times, objs, params,  \
    save_name, ctifile

print('\n     Running simulation\n')
# Set up problem instance
SEI_1D = Implicit_Problem(residual_homogeneous, SV_0, SV_dot_0)
